    ...
    return MaterialApp(
      ...
      routes: {
        ...
        ItemScreen.id: (context) {
          ...
          return ItemScreen(selectedCategoryId: args['categoryId']);
        },
        EditKategoriScreen.id: (context) {
          final args = ModalRoute.of(context)!.settings.arguments as GetImage;
          return EditKategoriScreen(kategori: args);
        },
        BuatPesananScreen.id: (context) {
          final args =
              ModalRoute.of(context)!.settings.arguments
                  as Map<String, dynamic>;
          return BuatPesananScreen(
